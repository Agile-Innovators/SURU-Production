    ...
    <>
        ...
        <Body style={main}>
            <Container style={container}>
                <Section style={box}>
                    <Img
                        src="/static/stripe-logo.png" // Ruta relativa a la imagen
                        width="49"
                        height="21"
                        alt="Stripe"
                    />
                    ...
                    <Text style={paragraph}>
                        ...
                        simultaneously be used for both test and live requests,
                        so you can continue testing while accepting live
                        payments. Check out our{' '}
                        <Link
                            style={anchor}
