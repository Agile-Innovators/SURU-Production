...
import { Fence, Cctv, Truck, MapPinHouse, Rat, Paintbrush } from 'lucide-react';

export function AvailableServices() {
    return (
        <>
            <section className="text-center">
                <h3 className="mt-36 text-secondary">
                ...
                <p className="m-0 text-primary mt-4 mx-auto md:max-w-[700px] 2xl:max-w-[1032px]">
                    ...
                    related to cleaning, pest control, transportation,
                    gardening, and many more. Dare to try this platform and save
                    time!{' '}
                </p>
            </section>
            <div className="grid sm:grid-cols-2 grid-cols-1 lg:grid-cols-3 gap-8 mt-28 mx-auto items-center justify-items-center">
                ...
                <BasicCard
                    icon={
                        <MapPinHouse className="w-24 h-24 text-primary stroke-1" />
                    }
                ...
                <BasicCard
                    icon={
                        <Paintbrush className="w-24 h-24 text-primary stroke-1" />
                    }
                    title="Cleaning"
                    variant="border"
                    text="10 services available"
